...
iniglobals(int calling_pid)
{
		...
		now.critical = 0;
#ifdef VAR_RANGES
		logval("pIsWaiting", now.pIsWaiting);
		logval("qIsWaiting", now.qIsWaiting);
...
{	/* int i; */
	printf("global vars:\n");
	printf("	bit    pIsWaiting:	%d\n", now.pIsWaiting);
	printf("	bit    qIsWaiting:	%d\n", now.qIsWaiting);
	printf("	byte   turn:	%d\n", now.turn);
