...
#define _nstates2	3	/* notMaxShort */
#define minseq2	12
#define maxseq2	13
#define _endstate2	2

#define _nstates1	7	/* q */
#define minseq1	6
#define maxseq1	11
#define _endstate1	6

#define _nstates0	7	/* p */
#define minseq0	0
#define maxseq0	5
#define _endstate0	6
...
#define PnotMaxShort	((P2 *)_this)
typedef struct P2 { /* notMaxShort */
